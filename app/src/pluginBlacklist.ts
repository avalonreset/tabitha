export const PLUGIN_BLACKLIST = [
    ...
    'terminus-clickable-links', // now bundled with Tabitha
    'tabby-clickable-links', // now bundled with Tabitha
    'terminus-clickable-ips', // broken, functionality now bundled with Tabitha
